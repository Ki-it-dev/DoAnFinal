<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="module_ThemSanPham.aspx.cs" Inherits="admin_page_QuanLySanPham_module_ThemSanPham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <formview>
        ...
        <div style="display: none; <%=mainStyle%>">
            <div class="form-group">
